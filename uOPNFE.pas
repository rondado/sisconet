...
uses
  ...
  FileCtrl,ACBrNFeNotasFiscais, uDmWorkCom;
...
procedure TFrmOpNfe.GravarConfiguracao;
Var IniFile : String ;
    Ini     : TIniFile ;
...
procedure TFrmOpNfe.LerConfiguracao;
Var IniFile  : String ;
    Ini     : TIniFile ;
    Ok : Boolean;
    StreamMemo : TMemoryStream;
...
procedure TFrmOpNfe.LoadConsulta201(XML: AnsiString);
var
  DOM: IXMLDocument;
  lXML: AnsiString;
...
procedure TFrmOpNfe.LoadXML(RetWS: String; MyWebBrowser: TWebBrowser);
begin
...
procedure TFrmOpNfe.sbtnCaminhoCertClick(Sender: TObject);
begin
...
procedure TFrmOpNfe.sbtnLogoMarcaClick(Sender: TObject);
begin
...
procedure TFrmOpNfe.sbtnPathSalvarClick(Sender: TObject);
begin
 PathClick(edtPathLogs);
end;

procedure TFrmOpNfe.FormCreate(Sender: TObject);
var
 T : TSSLLib;
 I : TpcnTipoEmissao ;
 J : TpcnModeloDF;
...
procedure TFrmOpNfe.FormShow(Sender: TObject);
begin
...
procedure TFrmOpNfe.btnSalvarConfigClick(Sender: TObject);
begin
 GravarConfiguracao;
 LerConfiguracao;
end;

procedure TFrmOpNfe.btnStatusServClick(Sender: TObject);
begin
...
procedure TFrmOpNfe.btnConsultarClick(Sender: TObject);
begin
...
procedure TFrmOpNfe.btnCancNFClick(Sender: TObject);
var
  idLote,vAux : String;
begin
  OpenDialog1.Title := 'Selecione a NFE';
...
procedure TFrmOpNfe.btnValidarXMLClick(Sender: TObject);
begin
  OpenDialog1.Title := 'Selecione a NFE';
  OpenDialog1.DefaultExt := '*-nfe.XML';
  OpenDialog1.Filter := 'Arquivos NFE (*-nfe.XML)|*-nfe.XML|Arquivos XML (*.XML)|*.XML|Todos os Arquivos (*.*)|*.*';
...
procedure TFrmOpNfe.cbTipoEmissaoChange(Sender: TObject);
begin
  if cbTipoEmissao.ItemIndex <> -1 then
    ACBrNFe1.Configuracoes.Geral.SSLLib := TSSLLib(cbTipoEmissao.ItemIndex);
...
procedure TFrmOpNfe.btnManifDestConfirmacaoClick(Sender: TObject);
var
...
procedure TFrmOpNfe.btnNfeDestinadasClick(Sender: TObject);
var
...
procedure TFrmOpNfe.btnImprimirClick(Sender: TObject);
begin
  OpenDialog1.Title := 'Selecione a NFE';
  OpenDialog1.DefaultExt := '*-nfe.XML';
  OpenDialog1.Filter := 'Arquivos NFE (*-nfe.XML)|*-nfe.XML|Arquivos XML (*.XML)|*.XML|Todos os Arquivos (*.*)|*.*';
...
procedure TFrmOpNfe.btnCriarEnviarClick(Sender: TObject);
var
...
procedure TFrmOpNfe.btnInutilizarClick(Sender: TObject);
var
...
procedure TFrmOpNfe.btnInutilizarImprimirClick(Sender: TObject);
begin
//  OpenDialog1.Title := 'Selecione a NFE';
...
procedure TFrmOpNfe.ACBrNFe1StatusChange(Sender: TObject);
begin
...
procedure TFrmOpNfe.sbtnGetCertClick(Sender: TObject);
begin
  edtNumSerie.Text := ACBrNFe1.SSL.SelecionarCertificado;
end;

procedure TFrmOpNfe.btnGerarNFEClick(Sender: TObject);
var
 vAux : String;
begin
if not(InputQuery('WebServices Enviar', 'Numero da Nota', vAux)) then
...
procedure TFrmOpNfe.btnConsCadClick(Sender: TObject);
var
 UF, Documento : String;
begin
...
procedure TFrmOpNfe.btnGerarPDFClick(Sender: TObject);
begin
  OpenDialog1.Title := 'Selecione a NFE';
  OpenDialog1.DefaultExt := '*-nfe.XML';
  OpenDialog1.Filter := 'Arquivos NFE (*-nfe.XML)|*-nfe.XML|Arquivos XML (*.XML)|*.XML|Todos os Arquivos (*.*)|*.*';
...
procedure TFrmOpNfe.btnGerarTXTClick(Sender: TObject);
var
   vAux, vNumLote : String;
begin
  if not(InputQuery('WebServices Enviar', 'Numero da Nota', vAux)) then
...
procedure TFrmOpNfe.btnEnviarEmailClick(Sender: TObject);
var
 Para : String;
 CC: Tstrings;
begin
...
procedure TFrmOpNfe.btnConsultarReciboClick(Sender: TObject);
var
  aux : String;
begin
...
procedure TFrmOpNfe.ACBrNFe1GerarLog(const Mensagem: String);
begin
 memoLog.Lines.Add(Mensagem);
end;

procedure TFrmOpNfe.btnImportarXMLClick(Sender: TObject);
var
  i, j, k, n  : integer;
...
procedure TFrmOpNfe.lblMouseEnter(Sender: TObject);
begin
 TLabel(Sender).Font.Style := [fsBold,fsUnderline];
end;

procedure TFrmOpNfe.lblMouseLeave(Sender: TObject);
begin
 TLabel(Sender).Font.Style := [fsBold];
end;

procedure TFrmOpNfe.lblColaboradorClick(Sender: TObject);
begin
  OpenURL('http://acbr.sourceforge.net/drupal/?q=node/5');
end;

procedure TFrmOpNfe.lblPatrocinadorClick(Sender: TObject);
begin
  OpenURL('http://acbr.sourceforge.net/drupal/?q=node/35');
end;

procedure TFrmOpNfe.lblDoar1Click(Sender: TObject);
begin
  OpenURL('http://acbr.sourceforge.net/drupal/?q=node/14');
end;

procedure TFrmOpNfe.GerarNFe(NumNFe : String);
...
procedure TFrmOpNfe.GerarNFCe(NumNFe: String);
begin
...
procedure TFrmOpNfe.btnConsultarChaveClick(Sender: TObject);
var
 vChave : String;
begin
...
procedure TFrmOpNfe.btnCancelarChaveClick(Sender: TObject);
var
...
procedure TFrmOpNfe.btnAdicionarProtNFeClick(Sender: TObject);
var
  NomeArq : String;
begin
  OpenDialog1.Title := 'Selecione a NFE';
...
procedure TFrmOpNfe.btnCarregarXMLEnviarClick(Sender: TObject);
begin
  OpenDialog1.Title := 'Selecione a NFE';
  OpenDialog1.DefaultExt := '*-nfe.XML';
  OpenDialog1.Filter := 'Arquivos NFE (*-nfe.XML)|*-nfe.XML|Arquivos XML (*.XML)|*.XML|Todos os Arquivos (*.*)|*.*';
...
procedure TFrmOpNfe.btnCartadeCorrecaoClick(Sender: TObject);
var
...
procedure TFrmOpNfe.btnValidarAssinaturaClick(Sender: TObject);
var
  Msg : String;
begin
  OpenDialog1.Title := 'Selecione a NFE';
...
procedure TFrmOpNfe.btnImprimirCCeClick(Sender: TObject);
begin
  OpenDialog1.Title := 'Selecione a NFE';
  OpenDialog1.DefaultExt := '*.XML';
  OpenDialog1.Filter := 'Arquivos XML (*.XML)|*.XML|Todos os Arquivos (*.*)|*.*';
...
procedure TFrmOpNfe.btnEnviarEventoClick(Sender: TObject);
var
 Para : String;
 CC, Evento: Tstrings;
begin
...
procedure TFrmOpNfe.btnCriarEnviarNFCeClick(Sender: TObject);
var
...
procedure TFrmOpNfe.btnDistribuicaoDFeClick(Sender: TObject);
var
...
procedure TFrmOpNfe.PathClick(Sender: TObject);
var
  Dir: string;
begin
...
procedure TFrmOpNfe.sbPathNFeClick(Sender: TObject);
begin
 PathClick(edtPathNFe);
end;

procedure TFrmOpNfe.sbPathCanClick(Sender: TObject);
begin
 PathClick(edtPathCan);
end;

procedure TFrmOpNfe.sbPathCCeClick(Sender: TObject);
begin
 PathClick(edtPathCCe);
end;

procedure TFrmOpNfe.sbPathInuClick(Sender: TObject);
begin
 PathClick(edtPathInu);
end;

procedure TFrmOpNfe.sbPathDPECClick(Sender: TObject);
begin
 PathClick(edtPathDPEC);
end;

procedure TFrmOpNfe.sbPathEventoClick(Sender: TObject);
begin
 PathClick(edtPathEvento);
end;

procedure TFrmOpNfe.spPathSchemasClick(Sender: TObject);
begin
 PathClick(edtPathSchemas);
end;

procedure TFrmOpNfe.Button1Click(Sender: TObject);
begin
  ShowMessage( FormatDateBr(ACBrNFe1.SSL.CertDataVenc) );
end;

procedure TFrmOpNfe.Button2Click(Sender: TObject);
begin
  ShowMessage( ACBrNFe1.SSL.CertNumeroSerie );
end;

procedure TFrmOpNfe.Button3Click(Sender: TObject);
begin
  ShowMessage( ACBrNFe1.SSL.CertSubjectName + sLineBreak + sLineBreak +
               'Razão Social: '+ACBrNFe1.SSL.CertRazaoSocial);   
end;

procedure TFrmOpNfe.Button4Click(Sender: TObject);
begin
  ShowMessage( ACBrNFe1.SSL.CertCNPJ );
end;

procedure TFrmOpNfe.Button5Click(Sender: TObject);
var
  Ahash: AnsiString;
begin

inherited FrmContasnovo: TFrmContasnovo
  ...
  inherited QryConsulta: TSQLQuery
    ...
    SQL.Strings = (
        ...
        'select contas.data_lanc,contas.data_venc,Contas.ID, contas.idfor' +
        'ma_pagto,'
    ...
    object QryConsultaIDFORMA_PAGTO: TIntegerField
      FieldName = 'IDFORMA_PAGTO'
    end
    object QryConsultaCOO: TIntegerField
      FieldName = 'COO'
    end
    object QryConsultaCCF: TIntegerField
      FieldName = 'CCF'
    end
  end
  ...
  inherited CdsConsulta: TClientDataSet
    ...
    object CdsConsultaIDFORMA_PAGTO: TIntegerField
      FieldName = 'IDFORMA_PAGTO'
    end
    object CdsConsultaCOO: TIntegerField
      FieldName = 'COO'
    end
    object CdsConsultaCCF: TIntegerField
      FieldName = 'CCF'
    end
    object CdsConsultaFORMAPAGTO: TStringField
      FieldKind = fkLookup
      FieldName = 'FORMAPAGTO'
      LookupDataSet = DmWorkCom.CdsFormaPag
      LookupKeyFields = 'ID'
      LookupResultField = 'DESCRICAO'
      KeyFields = 'IDFORMA_PAGTO'
      Lookup = True
    end
  end
  ...
  inherited ImageList1: TImageList
    ...
    Top = 328
    Bitmap = {
      494C01010B0098000C0110001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43187.614252789350000000

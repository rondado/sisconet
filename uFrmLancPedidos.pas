           ...
           begin
            ...
            begin
                ...
                begin
                    ...
                    begin
                       ShowMessage('Atenção! Saldo Insuficiente para esta Tabela de Preços');
                       Abort;
                    end;
            ...
            begin
                ShowMessage('Não Encontrou Registros do Produto '+DmProdutos.CdsProdutosID.AsString+' na Tabela ' + EdTabela.Text);
                Abort;
            end;
           end;
          end;
...
begin
  ...
  begin
    MessageDlg('Atenção! Este pedido se encontra cancelado ou Confirmado. Verifique!!!', mtWarning, [mbOK], 0);
//fabricio novo    Abort;
  end;
...
begin
  ...
  begin
    if Confirmacao('Confirma a exclusão do volume selecionado?') then
    begin

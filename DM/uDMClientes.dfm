object DmClientes: TDmClientes
  ...
  object CdsFuncionariosAux: TClientDataSet
    ...
    Left = 544
    Top = 96
    object CdsFuncionariosAuxID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object CdsFuncionariosAuxNOME: TStringField
      FieldName = 'NOME'
      Size = 50
    end
    object CdsFuncionariosAuxENDERECO: TStringField
      FieldName = 'ENDERECO'
      Size = 30
    end
    object CdsFuncionariosAuxNUMERO: TStringField
      FieldName = 'NUMERO'
      Size = 10
    end
    object CdsFuncionariosAuxBAIRRO: TStringField
      FieldName = 'BAIRRO'
    end
    object CdsFuncionariosAuxCIDADE: TStringField
      FieldName = 'CIDADE'
    end
    object CdsFuncionariosAuxCEP: TStringField
      FieldName = 'CEP'
      Size = 10
    end
    object CdsFuncionariosAuxUF: TStringField
      FieldName = 'UF'
      FixedChar = True
      Size = 2
    end
    object CdsFuncionariosAuxTELEFONE: TStringField
      FieldName = 'TELEFONE'
      Size = 12
    end
    object CdsFuncionariosAuxTELEFAX: TStringField
      FieldName = 'TELEFAX'
      Size = 12
    end
    object CdsFuncionariosAuxCELULAR: TStringField
      FieldName = 'CELULAR'
      Size = 12
    end
    object CdsFuncionariosAuxCNPJ_CPF: TStringField
      FieldName = 'CNPJ_CPF'
    end
    object CdsFuncionariosAuxINSC_RG: TStringField
      FieldName = 'INSC_RG'
    end
    object CdsFuncionariosAuxFILIACAO_PAI: TStringField
      FieldName = 'FILIACAO_PAI'
      Size = 50
    end
    object CdsFuncionariosAuxFILIACAO_MAE: TStringField
      FieldName = 'FILIACAO_MAE'
      Size = 50
    end
    object CdsFuncionariosAuxDATA_NASC: TSQLTimeStampField
      FieldName = 'DATA_NASC'
    end
    object CdsFuncionariosAuxDATA_ADMISSAO: TSQLTimeStampField
      FieldName = 'DATA_ADMISSAO'
    end
    object CdsFuncionariosAuxDATA_DEMISSAO: TSQLTimeStampField
      FieldName = 'DATA_DEMISSAO'
    end
    object CdsFuncionariosAuxSALARIO: TFloatField
      FieldName = 'SALARIO'
    end
    object CdsFuncionariosAuxCOMISSAO: TStringField
      FieldName = 'COMISSAO'
      FixedChar = True
      Size = 1
    end
    object CdsFuncionariosAuxPERC_COMISSAO: TFloatField
      FieldName = 'PERC_COMISSAO'
    end
    object CdsFuncionariosAuxATIVO: TStringField
      FieldName = 'ATIVO'
      Required = True
      FixedChar = True
      Size = 1
    end
    object CdsFuncionariosAuxOBSERVACOES: TMemoField
      FieldName = 'OBSERVACOES'
      BlobType = ftMemo
      Size = 1
    end
    object CdsFuncionariosAuxEMAIL: TStringField
      FieldName = 'EMAIL'
      Size = 200
    end
    object CdsFuncionariosAuxTIPO: TIntegerField
      FieldName = 'TIPO'
    end
    object CdsFuncionariosAuxTIPO_COM: TIntegerField
      FieldName = 'TIPO_COM'
    end
    object CdsFuncionariosAuxSINCRONIZADO: TStringField
      FieldName = 'SINCRONIZADO'
      FixedChar = True
      Size = 1
    end

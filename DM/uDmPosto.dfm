object DmPosto: TDmPosto
  ...
  object QryBombasLacre: TSQLQuery
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object QryPlacasAbastec: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
  ...
  object QryTanquePerda: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
  ...
  object QryConfigPosto: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
  ...
  object QryBicoComunica: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
  ...
  object QryLivroLMCPag: TSQLQuery
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger

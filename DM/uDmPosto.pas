...
uses
  ...
  SHDocVw, unitVidaLink, CharPrinter, ACBrSintegra;
//  SHDocVw,ACBrDFeUti, unitVidaLink, CharPrinter, ACBrSintegra;
...
type
  TDmPosto = class(TDataModule)
    ...
    procedure DspConfigPostoGetTableName(Sender: TObject;
      DataSet: TDataSet; var TableName: String);
    procedure DspBicosGetTableName(Sender: TObject; DataSet: TDataSet;
      var TableName: String);
    procedure DspBombasGetTableName(Sender: TObject; DataSet: TDataSet;
      var TableName: String);
    ...
    procedure DspTanquesGetTableName(Sender: TObject; DataSet: TDataSet;
      var TableName: String);
    procedure CdsConfigPostoNewRecord(DataSet: TDataSet);
    procedure CdsBicoPerdaNewRecord(DataSet: TDataSet);
    procedure DspBicoPerdaGetTableName(Sender: TObject; DataSet: TDataSet;
      var TableName: String);
    procedure DspPlacasAbastecGetTableName(Sender: TObject;
      DataSet: TDataSet; var TableName: String);
    procedure CdsPlacasAbastecNewRecord(DataSet: TDataSet);
    procedure DspBombasLacreGetTableName(Sender: TObject;
      DataSet: TDataSet; var TableName: String);
    procedure DspAbastecimentosGetTableName(Sender: TObject;
      DataSet: TDataSet; var TableName: String);
    ...
    procedure DspAbastTempGetTableName(Sender: TObject; DataSet: TDataSet;
      var TableName: String);
    procedure CdsAbastTempNewRecord(DataSet: TDataSet);
    procedure DspLivroLMCGetTableName(Sender: TObject; DataSet: TDataSet;
      var TableName: string);
    procedure DspLivroLMCPagGetTableName(Sender: TObject; DataSet: TDataSet;
      var TableName: string);
  private
...
//    function Dados_TanqueEstoque:Boolean;
    ...
    procedure RegistraAbastecimentos(pNumBico,pData,pHora:String;
                                     pEncerrante,pLitros,pValUnit,pTotal:Double;
                                     pRemanecente:Boolean=false;
                                     pAutomatico:Boolean=false;
                                     pNumNota:String='');
    procedure RegistraAbastTemporario(pNumBico,pData,pHora:String;
                                      pEncerrante,pLitros,pValUnit,pTotal:Double;
                                      pRemanecente:Boolean=false;
                                      pAutomatico:Boolean=false;
                                      pNumNota:String='');
    ...
    function Gera_Registro_Manutencao_Bomba(EF,EI:Double;
                                            pIDBomba,pIDTanque,pIDBico:Integer;
                                            pData,pHora:TDateTime;
                                            pCNPJ,pCPF,pLacreOld,pLacreNew,pMotivo,
                                            pMotivo1,pMotivo2,pJustificativa,
                                            pJustificativa1,pJustificativa2,pMedidas,
                                            pMedidas1,pMedidas2:String):Boolean;
    ...
    function Grava_Encerrante_Manutencao_Bomba(pIDPlaca:Integer;
                                               pEncerrante,pVESPEB:Double):Boolean;
    procedure GravaArquivoConfigPosto;
    procedure RetornaStatusAbastecCupom(pIDCupom:Integer);
    procedure AlteraStatusAbastecimento(pID, pStatus, pCOO:Integer;
                                        pNotaFiscal:String;
                                        pDataEmissao:TDateTime=0;
                                        pHoraEmissao:TDateTime=0);
    ...
    function RetornaDadosBicoPerda(var NumBico : String;
                                   var EF:Double;
                                   var EI:Double;
                                   var Data : TDateTime;
                                   var Hora: TDateTime;
    ...
    function RetornaDadosDescontinuidade(var EncIn:Double; var EncOut: Double;
                                         var HoraQuebra : TDateTime;
                                         pIDBico: Integer; pDataMov: TDateTime): Boolean;
    ...
    function GeraAbastecimentoSaldoRemanecente(var Quantidade:Double;
                                               var DataAbastec:TDateTime;
                                               pDataMov:TDateTime;
                                               pNumBico:String;
                                               pVespeb:Double):Double;
    function GeraAbastecimentoSaldoRemanecentePeriodo(var Quantidade:Double;
                                                      var DataAbastec:TDateTime;
                                                      pDataMov:TDateTime;
                                                      pNumBico:String;
                                                      pVespeb:Double;
                                                      pTipo:Integer;
                                                      pHoraBase:TDateTime):Double;
    function RetornaCapacidadeTanque(pIDProduto: Integer): Double;
    Procedure RetornaDadosVespeb(var pVespeb:Double; var pEnc_Out:Double; var pEnc_In:Double;
                                 pIDBico:Integer; pData:TDateTime);
    function VerificaDescontinuidadeRegistrada(pIDBico:Integer;
                                               pData:TDateTime;
                                               pVespeb:Double):Boolean;
    procedure Grava_RegistroLivroLMC(pPagina: Integer;
                                     pLivro:Integer=0;
                                     pQuantPag:integer=0;
                                     pDataAbertura:TDateTime=0;
                                     pDataFechamento:TDateTime=0;
                                     pIDResponsavel:integer=0;
                                     pIDConferente:integer=0;
                                     pIDGerente:integer=0);
    function VerificaPrimeiroItemDataLivro(pData:TdateTime):Boolean;
    function VerificaPaginasUltimaMov(DataMovAtual:TDateTime):Boolean;
    function VerificaProdutoLMCPagima(pIDProduto:Integer;pData:TDateTime):Boolean;
    function VerificaDataUltimoMovimento(pDataMov:TdateTime):Boolean;
    procedure RegistraNovaPagina(pNumLivro,pIDProduto:Integer;pDataMov:TDateTime);
    function RetornaNumeroPagina(pNumLivro:Integer):Integer;
    function VerificaProdutosLMCData(pDataMov:TDateTime):Boolean;
  end;
...
uses uDmConexao, uDmWorkCom, uLibrary, uDMClientes, uFuncoesPosto, uDmProdutos;
...
procedure TDmPosto.DspConfigPostoGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: String);
begin
...
procedure TDmPosto.DspLivroLMCGetTableName(Sender: TObject; DataSet: TDataSet;
  var TableName: string);
begin
  TableName := 'LIVRO_LMC';
...
procedure TDmPosto.DspBicosGetTableName(Sender: TObject; DataSet: TDataSet;
  var TableName: String);
begin
...
procedure TDmPosto.DspBombasGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: String);
begin
...
procedure TDmPosto.RegistraAbastecimentos(pNumBico, pData, pHora: String;
  pEncerrante, pLitros, pValUnit, pTotal: Double; pRemanecente,
  pAutomatico: Boolean;pNumNota:String);
...
//  CdsAbastecimentos.FieldByName('VALOR_TOTAL').AsFloat     := pTotal;
  ...
  // grava no produto
  Grava_MovEstoque(CdsTanques.FieldByName('ID_PRODUTO').AsInteger,
                   aNovoEstoque);
  DmProdutos.Grava_EstoqueDia(CdsTanques.FieldByName('ID_PRODUTO').AsInteger);
  // grava tabela de movimento de estoque
  DmProdutos.Grava_TabMovEst(0,CdsTanques.FieldByName('ID_PRODUTO').AsInteger,
                             pLitros);
...
procedure TDmPosto.DspTanquesGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: String);
begin
...
procedure TDmPosto.DspBicoPerdaGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: String);
begin
...
procedure TDmPosto.VerificaResolvePennciaEstoqueCombustivel(
  fItens: TDataSet);
var NumBico : String;  
begin
  fItens.First;
...
function TDmPosto.VerificaMovimentoBico(DataMov: TDateTime;
  NumBico: String): Boolean;
var Q : TSQLQuery;
begin
  Q := TSQLQuery.Create(nil);
  try
...
function TDmPosto.RetornaEncerranteUltZ(DataMov: TDateTime;
  NumBico: String): Double;
var Q : TSQLQuery;
begin
  Result := 0;
  Q := TSQLQuery.Create(nil);
...
procedure TDmPosto.DspPlacasAbastecGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: String);
begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          // retorna o total de cupons emitidos para o item
          VTACF := RetornaTotalAbastecPeriodo(Q.FieldByName('bico_concentrador').AsString,
                                              Q.FieldByName('idproduto').AsInteger,
                                              4,Q.FieldByName('tipo').AsInteger,
                                              Q.FieldByName('data_redz').AsDateTime,
                                              'S',Q.FieldByName('HORA_QUEBRA').AsDateTime);
          VTACF := StrToFloat(FormatFloat('0.000',VTACF));
          // retorna o total de NF emitida para o item
          VTANF := RetornaTotalAbastecPeriodo(Q.FieldByName('bico_concentrador').AsString,
                                             Q.FieldByName('idproduto').AsInteger,
                                             3,Q.FieldByName('tipo').AsInteger,
                                             Q.FieldByName('data_redz').AsDateTime,
                                             'S',Q.FieldByName('HORA_QUEBRA').AsDateTime);
          VTANF := StrToFloat(FormatFloat('0.000',VTANF));
          // retorna o total de afericoes para o item
          AFER := RetornaTotalAbastecPeriodo(Q.FieldByName('bico_concentrador').AsString,
                                             Q.FieldByName('idproduto').AsInteger,
                                             2,Q.FieldByName('tipo').AsInteger,
                                             Q.FieldByName('data_redz').AsDateTime,
                                             'S',Q.FieldByName('HORA_QUEBRA').AsDateTime);
          AFER := StrToFloat(FormatFloat('0.000',AFER));
        end;
      ...
      begin
        ...
        begin
          ...
          VTACF := RetornaTotalAbastecimento(Q.FieldByName('bico_concentrador').AsString,
                                             Q.FieldByName('idproduto').AsInteger,
                                             4,DmAcBr.ACBrECF1.DataMovimento,
                                             'N');
          VTACF := StrToFloat(FormatFloat('0.000',VTACF));
          // retorna o total de NF emitida para o item
          VTANF := RetornaTotalAbastecimento(Q.FieldByName('bico_concentrador').AsString,
                                             Q.FieldByName('idproduto').AsInteger,
                                             3,DmAcBr.ACBrECF1.DataMovimento,
                                             'N');
          VTANF := StrToFloat(FormatFloat('0.000',VTANF));
          // retorna o total de afericoes para o item
          AFER := RetornaTotalAbastecimento(Q.FieldByName('bico_concentrador').AsString,
                                             Q.FieldByName('idproduto').AsInteger,
                                             2,DmAcBr.ACBrECF1.DataMovimento,
                                             'N');
          AFER := StrToFloat(FormatFloat('0.000',AFER));
        end
        else
        begin
          ...
          VTACF := RetornaTotalAbastecPeriodo(Q.FieldByName('bico_concentrador').AsString,
                                             Q.FieldByName('idproduto').AsInteger,
                                             4,Q.FieldByName('tipo').AsInteger,
                                             DmAcBr.ACBrECF1.DataMovimento,
                                             'N',Q.FieldByName('HORA_QUEBRA').AsDateTime);
          VTACF := StrToFloat(FormatFloat('0.000',VTACF));
          // retorna o total de NF emitida para o item
          VTANF := RetornaTotalAbastecPeriodo(Q.FieldByName('bico_concentrador').AsString,
                                             Q.FieldByName('idproduto').AsInteger,
      ...
      end;
{
      ...
      begin
        ...
        begin
          ...
          begin
            EFRemanece := GeraAbastecimentoSaldoRemanecentePeriodo(aQuantRem,
                                                                   DataAbastec,
                                                                   Q.FieldByName('data_redz').AsDateTime,
                                                                   Q.FieldByName('bico_concentrador').AsString,
                                                                   VESPEB,
                                                                   Q.FieldByName('tipo').AsInteger,
                                                                   Q.FieldByName('HORA_QUEBRA').AsDateTime);
          end;
          if EFRemanece > 0 then
          begin
            if (aQuantRem < SALDO) and
               (aQuantRem > 0)  then
            begin
            ...
            begin
              RegistraAbastecimentos(Q.FieldByName('bico_concentrador').AsString,
                                     DateToStr(DmAcBr.ACBrECF1.DataMovimento),
                                     TimeToStr(Now),
                                     EFRemanece,
                                     SaldoRem,
                                     Q.FieldByName('valor').AsFloat,
...
procedure TDmPosto.AlteraStatusAbastecimento(pID, pStatus, pCOO: Integer;
  pNotaFiscal: String; pDataEmissao, pHoraEmissao: TDateTime);
begin
...
function TDmPosto.VerificaComunicacaoBicos(ReducaoZ:Boolean=false;
  SemComunicacao:Boolean=false;pDataMov:TdateTime=0): Boolean;
...
function TDmPosto.Gera_Registro_Manutencao_Bomba(EF,EI: Double; pIDBomba,
  pIDTanque, pIDBico: Integer; pData, pHora: TDateTime; pCNPJ, pCPF,
  pLacreOld, pLacreNew, pMotivo,pMotivo1,pMotivo2, pJustificativa,
  pJustificativa1,pJustificativa2,pMedidas,pMedidas1,pMedidas2: String): Boolean;
var Q : TSQLQuery;
begin
  Q := TSQLQuery.Create(nil);
  try
...
function TDmPosto.Grava_Encerrante_Manutencao_Bomba(pIDPlaca: Integer;
  pEncerrante, pVESPEB: Double): Boolean;
var Q : TSQLQuery;
begin
  Q := TSQLQuery.Create(nil);
...
procedure TDmPosto.Grava_RegistroLivroLMC(pPagina: Integer; pLivro:Integer=0;
  pQuantPag:integer=0;pDataAbertura:TDateTime=0;pDataFechamento:TDateTime=0;
  pIDResponsavel:integer=0;pIDConferente:integer=0;pIDGerente:integer=0);
begin
  if CdsLivroLMC.RecordCount = 0 then
  begin
    CdsLivroLMC.Append;
...
function TDmPosto.RetornaNumeroPagina(pNumLivro: Integer): Integer;
var Q : TSQLQuery;
begin
  Q := TSQLQuery.Create(nil);
  try
    ...
    Q.Close;
    Q.SQL.Clear;
    Q.SQL.Add('select (coalesce(p.pag_atual_impressa,0)+1) as numlivro from livro_lmc p');
    Q.SQL.Add('where p.num_livro = '+IntToStr(pNumLivro));
    Q.Open;
    Result := Q.FieldByName('numlivro').AsInteger;
    Q.Close;
  finally
    FreeAndNil(Q);
  end;
...
procedure TDmPosto.DspBombasLacreGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: String);
begin
...
procedure TDmPosto.DspAbastecimentosGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: String);
begin
...
procedure TDmPosto.DspLivroLMCPagGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: string);
begin
...
function TDmPosto.RetornaDadosBicoPerda(var NumBico: String;
  var EF: Double; var EI:Double; var Data : TDateTime; var Hora: TDateTime;
  IDPerda: Integer): Boolean;
var Q : TSQLQuery;
begin
  Result := false;
...
procedure TDmPosto.RegistraAbastTemporario(pNumBico, pData, pHora: String;
  pEncerrante, pLitros, pValUnit, pTotal: Double; pRemanecente,
  pAutomatico: Boolean; pNumNota: String);
var aEstAtual,aNovoEstoque : Double;
begin
...
procedure TDmPosto.RegistraNovaPagina(pNumLivro, pIDProduto: Integer;
  pDataMov: TDateTime);
var aPagina : Integer;
begin
  DmProdutos.Dados_Produto(pIDProduto);
  DmProdutos.Dados_Estoque(pIDProduto,sIDEmpresa);
  // Captura o numero da proxima pagina
  aPagina := RetornaNumeroPagina(pNumLivro);
  // registra a pagina
  CdsLivroLMCPag.Append;
  CdsLivroLMCPagNUM_LIVRO.AsInteger := pNumLivro;
  CdsLivroLMCPagNUM_PAGINA.AsInteger := aPagina;
  CdsLivroLMCPagDATA_PAGINA.AsDateTime := pDataMov;
  CdsLivroLMCPagID_PRODUTO.AsInteger := pIDProduto;
  CdsLivroLMCPagEST_FECHAMENTO.AsFloat := DmProdutos.CdsEstoqueQUANTIDADE.AsFloat;;
  CdsLivroLMCPagDESCRICAO.AsString := DmProdutos.CdsProdutosDESCRICAO.AsString;
  Grava_Dados(CdsLivroLMCPag);
  // atualiza a pagina
  CdsLivroLMC.Edit;
  CdsLivroLMCPAG_ATUAL_IMPRESSA.AsInteger := aPagina;
  Grava_Dados(CdsLivroLMC);

end;

procedure TDmPosto.DspAbastTempGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: String);
begin
...
function TDmPosto.VerificaMovtoBicoAbast(DataMov: TDateTime;
  NumBico: String): Boolean;
var Q : TSQLQuery;
begin
  Q := TSQLQuery.Create(nil);
...
begin
  ...
  begin
    if Controle then
    begin
      if (copy(valor,i,1) = '0') or (copy(valor,i,1) = '1') or
         (copy(valor,i,1) = '2') or (copy(valor,i,1) = '3') or
         (copy(valor,i,1) = '4') or (copy(valor,i,1) = '5') or
         (copy(valor,i,1) = '6') or (copy(valor,i,1) = '7') or
         (copy(valor,i,1) = '8') or (copy(valor,i,1) = '9') then
      begin
        Zeros := Zeros + '0';
      end;
    end;
...
function TDmPosto.VerificaPaginasUltimaMov(DataMovAtual:TDateTime): Boolean;
var Q : TSQLQuery;
    aDataMov, AuxData : TDateTime;
begin
  Result := true;
  Q := TSQLQuery.Create(nil);
  try
    aDataMov := StrToDate('01/01/1999');
    AuxData := StrToDate(FormatDateTime('dd/mm/yyyy',DataMovAtual));
    // captura a data do ultimo movimento
    with Q do
    begin
      SQLConnection := ConexaoDados;
      Close;
      SQL.Clear;
      SQL.Add('select max(p.data_pagina) as datamov from livro_lmc_pag p');
      Open;
      aDataMov := Q.FieldByName('datamov').AsDateTime;
      Close;
    end;
    // se não tiver movimento de livro, captura a data do ultimo movimento pedido
    if aDataMov = StrToDate('01/01/1999') then
    begin
      with Q do
      begin
        SQLConnection := ConexaoDados;
        Close;
        SQL.Clear;
        SQL.Add('select cast(max(p.data_entrega) as date) as datamov from pedido p');
        SQL.Add('inner join pedido_itens i on p.id = i.idpedido');
        SQL.Add('where p.abastecimento = '+QuotedStr('S'));
        Open;
        aDataMov := Q.FieldByName('datamov').AsDateTime;
        Close;
      end;
    end;
    // verifica se tem algum produto impresso para a data
    if (VerificaProdutosLMCData(aDataMov)) and (AuxData > aDataMov) then
    begin
      // lista os produtos combustivel
      with Q do
      begin
        SQLConnection := ConexaoDados;
        Close;
        SQL.Clear;
        SQL.Add('select pr.id,pr.descricao from produtos pr');
        SQL.Add('where pr.combustivel = '+QuotedStr('S'));
        Open;
        while not Eof do
        begin
          if not VerificaProdutoLMCPagima(FieldByName('id').AsInteger,aDataMov) then
          begin
            Result := false;
            Break;
          end;
...
function TDmPosto.RetornaDadosDescontinuidade(var EncIn:Double; var EncOut:Double;
  var HoraQuebra : TDateTime; pIDBico:Integer;pDataMov: TDateTime): Boolean;
var Q : TSQLQuery;
begin
  EncIn  := 0;
  EncOut := 0;
...
function TDmPosto.RetornaQuantVendidaPeriodo(DataMov, HoraBase: TDateTime;
  NumBico: String;TipoMov:Integer): Double;
var Q : TSQLQuery;
    AuxHora : String;
begin
...
function TDmPosto.VerificaProdutoLMCPagima(pIDProduto: Integer;
...
begin
  ...
  try
    Q.SQLConnection := ConexaoDados;
    Q.Close;
    Q.SQL.Add('select ll.num_livro from livro_lmc ll');
    Q.SQL.Add('inner join livro_lmc_pag lp on ll.num_livro = lp.num_livro');
    Q.SQL.Add('where lp.data_pagina = :pData');
    Q.SQL.Add('and lp.id_produto = :pIDProduto');
    Q.Params.ParamByName('pIDProduto').AsInteger := pIDProduto;
    Q.Params.ParamByName('pData').AsDate := pData;
    Q.Open;
    Result := not Q.IsEmpty;
    Q.Close;
...
function TDmPosto.VerificaProdutosLMCData(pDataMov: TDateTime): Boolean;
var Q : TSQLQuery;
begin
  Q := TSQLQuery.Create(nil);
  try
    ...
    Q.Close;
    Q.SQL.Clear;
    Q.SQL.Add('select p.num_livro from livro_lmc_pag p');
    Q.SQL.Add('where p.data_pagina = :pData');
...
function TDmPosto.VerificaMovimentoBicoNF(DataMov: TDateTime;
  NumBico: String): Boolean;
var Q : TSQLQuery;
begin
  Q := TSQLQuery.Create(nil);
...
function TDmPosto.GeraAbastecimentoSaldoRemanecente(var Quantidade:Double;
  var DataAbastec:TDateTime; pDataMov:TDateTime;
  pNumBico:String; pVespeb:Double):Double;
var Q : TSQLQuery;
...
procedure TDmPosto.RetornaDadosVespeb(var pVespeb:Double; var pEnc_Out:Double;
  var pEnc_In:Double;pIDBico:Integer; pData:TDateTime);
var Q : TSQLQuery;
begin
  Q := TSQLQuery.Create(nil);
  try
...
function TDmPosto.GeraAbastecimentoSaldoRemanecentePeriodo(
  var Quantidade: Double; var DataAbastec: TDateTime; pDataMov: TDateTime;
  pNumBico: String; pVespeb: Double;pTipo:Integer;pHoraBase:TDateTime): Double;
var Q : TSQLQuery;
    aEncAnterior, aEncAtual, aEncCompara, aLitrosAtual, aDif, AuxVespeb : Double;
    AuxHora : String;
begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if VerificaDescontinuidadeRegistrada(CdsBicos.FieldByname('ID').AsInteger,
                                               Q.FieldByName('DATA_ABAST').AsDateTime,
                                               aDif) then
          begin
            aDif := 0;
          end;
...
function TDmPosto.VerificaDataUltimoMovimento(pDataMov: TdateTime): Boolean;
var Q : TSQLQuery;
begin
  Result := false;
  Q := TSQLQuery.Create(nil);
  try
    Q.SQLConnection := ConexaoDados;
    Q.Close;
    Q.SQL.Add('select max(p.data_pagina) as data from livro_lmc_pag p');
    Q.Open;
    if not Q.IsEmpty then
    begin
      if pDataMov < Q.FieldByName('Data').AsDateTime then
         Result := true;
    end;
    Q.Close;
  finally
...
function TDmPosto.VerificaDescontinuidadeRegistrada(pIDBico: Integer;
  pData: TDateTime; pVespeb: Double): Boolean;
var Q : TSQLQuery;
begin
  Q := TSQLQuery.Create(nil);
  try

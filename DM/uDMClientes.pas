...
uses
  ...
  SHDocVw, unitVidaLink;
//  SHDocVw, ACBrDFeUti, unitVidaLink;
...
type
  TDmClientes = class(TDataModule)
    ...
    QryFuncionariosOBSERVACOES: TMemoField;
    ...
    CdsFuncionariosOBSERVACOES: TMemoField;
    ...
    CdsFuncionariosAuxID: TIntegerField;
    CdsFuncionariosAuxNOME: TStringField;
    CdsFuncionariosAuxENDERECO: TStringField;
    CdsFuncionariosAuxNUMERO: TStringField;
    CdsFuncionariosAuxBAIRRO: TStringField;
    CdsFuncionariosAuxCIDADE: TStringField;
    CdsFuncionariosAuxCEP: TStringField;
    CdsFuncionariosAuxUF: TStringField;
    CdsFuncionariosAuxTELEFONE: TStringField;
    CdsFuncionariosAuxTELEFAX: TStringField;
    CdsFuncionariosAuxCELULAR: TStringField;
    CdsFuncionariosAuxCNPJ_CPF: TStringField;
    CdsFuncionariosAuxINSC_RG: TStringField;
    CdsFuncionariosAuxFILIACAO_PAI: TStringField;
    CdsFuncionariosAuxFILIACAO_MAE: TStringField;
    CdsFuncionariosAuxDATA_NASC: TSQLTimeStampField;
    CdsFuncionariosAuxDATA_ADMISSAO: TSQLTimeStampField;
    CdsFuncionariosAuxDATA_DEMISSAO: TSQLTimeStampField;
    CdsFuncionariosAuxSALARIO: TFloatField;
    CdsFuncionariosAuxCOMISSAO: TStringField;
    CdsFuncionariosAuxPERC_COMISSAO: TFloatField;
    CdsFuncionariosAuxATIVO: TStringField;
    CdsFuncionariosAuxOBSERVACOES: TMemoField;
    CdsFuncionariosAuxEMAIL: TStringField;
    CdsFuncionariosAuxTIPO: TIntegerField;
    CdsFuncionariosAuxTIPO_COM: TIntegerField;
    CdsFuncionariosAuxSINCRONIZADO: TStringField;
    ...
    procedure DspContatosADCGetTableName(Sender: TObject;
      DataSet: TDataSet; var TableName: String);
    procedure DspContatoAuxGetTableName(Sender: TObject; DataSet: TDataSet;
      var TableName: String);
    ...
    procedure DspFuncionariosGetTableName(Sender: TObject; DataSet: TDataSet;
      var TableName: string);
    ...
    procedure DspUsuariosPerrfilGetTableName(Sender: TObject; DataSet: TDataSet;
      var TableName: string);
    procedure DspUsuariosGetTableName(Sender: TObject; DataSet: TDataSet;
      var TableName: string);
    procedure DspUsuariosItensGetTableName(Sender: TObject; DataSet: TDataSet;
      var TableName: string);
    procedure DspUsuariosPermissoesGetTableName(Sender: TObject;
      DataSet: TDataSet; var TableName: string);
    ...
    procedure DspCodCidadeGetTableName(Sender: TObject; DataSet: TDataSet;
      var TableName: string);
  private
...
uses uDmWorkCom, uLibrary, uDmConexao;
...
procedure TDmClientes.DspContatosGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: String);
begin
  TableName := 'CONTATO';
...
begin
  ...
  //
  Grava_Endereco(DataSet.FieldByName('CEP_END').AsString,
                 DataSet.FieldByName('ENDERECO').AsString,
                 DataSet.FieldByName('BAIRRO_END').AsString,
                 DataSet.FieldByName('CIDADE_END').AsString,
                 DataSet.FieldByName('UF_END').AsString);
...
procedure TDmClientes.DspContatosADCGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: String);
begin
...
procedure TDmClientes.DspCodCidadeGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: string);
begin
  TableName := 'CODCIDADE';
...
procedure TDmClientes.DspContatoAuxGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: String);
begin
  TableName := 'CONTATO';
...
function TDmClientes.Dados_CodCidade(pNome: String;
  ValidarCidade: Boolean): Boolean;
begin
  CdsCodCidade.Close;
...
procedure TDmClientes.Grava_Endereco(fCep, fEnd, fBairro, fCidade,
  fUF: String);
begin
...
procedure TDmClientes.Insere_RegistroPerfil(fNome, fDescricao: String;
  fNivel: Integer);
begin
...
function TDmClientes.Dados_Permissoes(fIDPerfil: Integer;
  pNomeApp: String): Boolean;
begin
  CdsUsuariosPermissoes.Close;
  CdsUsuariosPermissoes.Params.Clear;
  //
...
procedure TDmClientes.DspEnderecoGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: String);
begin
  TableName := 'ENDERECO';
...
procedure TDmClientes.DspFuncionariosGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: string);
begin
...
procedure TDmClientes.DspUFGetTableName(Sender: TObject; DataSet: TDataSet;
  var TableName: String);
begin
...
procedure TDmClientes.DspUsuariosGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: string);
begin
  TableName := 'USUARIOS';
...
procedure TDmClientes.DspUsuariosItensGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: string);
begin
...
procedure TDmClientes.DspUsuariosPermissoesGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: string);
begin
...
procedure TDmClientes.DspUsuariosPerrfilGetTableName(Sender: TObject;
  DataSet: TDataSet; var TableName: string);
begin

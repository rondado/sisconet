object DmProdutos: TDmProdutos
  ...
  object QryProduto_Aliquota: TSQLQuery
    ...
    object QryProduto_AliquotaIMPOSTO_PFCP: TFloatField
      FieldName = 'IMPOSTO_PFCP'
      ProviderFlags = [pfInUpdate]
    end
    object QryProduto_AliquotaPFCP_EMBUTIDO: TStringField
      FieldName = 'PFCP_EMBUTIDO'
      ProviderFlags = [pfInUpdate]
      FixedChar = True
      Size = 1
    end
  ...
  object CdsProduto_Aliquota: TClientDataSet
    ...
    object CdsProduto_AliquotaIMPOSTO_PFCP: TFloatField
      FieldName = 'IMPOSTO_PFCP'
      ProviderFlags = [pfInUpdate]
    end
    object CdsProduto_AliquotaPFCP_EMBUTIDO: TStringField
      FieldName = 'PFCP_EMBUTIDO'
      ProviderFlags = [pfInUpdate]
      FixedChar = True
      Size = 1
  ...
  object QryProdutos: TSQLQuery
    ...
    object QryProdutosDESCONTO: TStringField
      FieldName = 'DESCONTO'
      FixedChar = True
      Size = 1
    end
  ...
  object CdsProdutos: TClientDataSet
    ...
    object CdsProdutosDESCONTO: TStringField
      FieldName = 'DESCONTO'
      FixedChar = True
      Size = 1
    end
  ...
  object CdsEmpenho: TClientDataSet
    ...
    OnNewRecord = CdsEmpenhoNewRecord
    Left = 547
    Top = 368

...
begin
	{Retorna os bicos configurados no módulo,
   só le os bicos a primeira vez ou se mudou a configuração.
   Isso é feito com a variável PegaBicos que é setada para true
   ao iniciar o sistema e também ao enviar configuração}
	if PegaBicos then
  begin
    NroRegistros := 0;
    for Slot := 1 to 6 do
...
begin
  ...
  cStr := Bico +
    			'0000000000' +   //Pulsos
    			DataHora +
          '00' + Preco + //Preco vem com 4, porém são 6 caracteres no layout

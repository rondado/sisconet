...
var
  ...
  sNFeNFCe: Integer;
  // procedures e funções de conexão com banco de dados
...
begin
  try
    ...
    begin
      MessageDlg('É necessário ter o numero do Danfe para prosseguir!',mtWarning,[mbOK],0);
      Result := false;
      Exit;
    end;
    // gera a NFe
          ...
          begin
            ...
            begin
              if (Copy(QryItens.FieldByName('CST_DANFE').AsString,2,2) = '40') or // 1 - Isento
                 (Copy(QryItens.FieldByName('CST_DANFE').AsString,2,2) = '41') then // 2 - Não tributado
              begin
                with II do
                begin

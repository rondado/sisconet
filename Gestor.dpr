...
uses
  ...
  uConsEmpenho in 'uConsEmpenho.pas' {frmConsempenho},
  ...
  uFrmListaCompras in 'uFrmListaCompras.pas' {FrmListaCompras},
  ...
  uRelQuita44Col in 'uRelQuita44Col.pas' {FRelQuita44Col},
  uFrmDadosCobranca in 'uFrmDadosCobranca.pas' {FrmDadosCobranca},
  uFrmLeCodigo in 'uFrmLeCodigo.pas' {FrmLeCodigo},
  uFrmCadBancos in 'uFrmCadBancos.pas' {FrmCadBancos},
  uFrmGerarFaturas in 'uFrmGerarFaturas.pas' {FrmGerarFaturas},
  ...
  u_relcxdiario in 'u_relcxdiario.pas' {frmcxdiarios},
  uFrmContasnovo in 'uFrmContasnovo.pas' {FrmContasnovo},
  uFrmContas in 'uFrmContas.pas' {FrmContas},
  unRecibo in 'unRecibo.pas' {frmRecibo},
  unImpro in 'unImpro.pas' {frmImpro},
  uFrmPedidosagrupa in 'uFrmPedidosagrupa.pas' {FrmPedidosAgrupa},
  uFrmCFOPPedido in 'uFrmCFOPPedido.pas' {FrmCFOPPedido},
  uFrmAtuPre in 'uFrmAtuPre.pas' {FrmAtuPre},
  uXML in 'uXML.pas' {frmxml},
  uFrmGeraNFe in 'uFrmGeraNFe.pas' {FrmGeraNFe},
  ufrmStatus in 'DM\ufrmStatus.pas' {frmStatus},
  ProxyConfig in 'ACBrIBPTax\ProxyConfig.pas' {frProxyConfig},
  ufrmIBPT in 'ACBrIBPTax\ufrmIBPT.pas' {frmIBPT};
...
//    Application.HelpFile := 'HELP.HLP';
  ...
  Application.CreateForm(TFrmGeraNFe, FrmGeraNFe);

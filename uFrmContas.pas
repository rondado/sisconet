...
uses
  ...
  Vcl.StdCtrls, Vcl.Buttons, Vcl.ExtCtrls, Vcl.ComCtrls, frxClass, frxDBSet, uFrmLiberacao;
...
begin
  inherited;
  frxReport1.LoadFromFile(ExtractFilePath(Application.ExeName)+'Relatorios\RelContas.fr3');
...
begin
  ...
  if DataConsulta.DataSet.RecordCount = 0 then
  begin
    MessageDlg('É necessário selecionar a conta a ser quitada, verifique!!!', mtWarning, [mbOK], 0);
    Abort;
  end;
  //
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          //rondado ajuste valor estorno
          valorEstorno :=   DmWorkCom.CdsContas.FieldByName('VALOR_QUITATO').AsFloat;
          DmWorkcom.sValorQuitato := valorEstorno;

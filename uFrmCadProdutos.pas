...
{
criar um arquivo tributos.ini... coolocar o INIFILES lá em cima no uses

colocar as variaveis lá em cima
traliquota_icms, traliquota_ipi, trtributacao,traliquota_pis, traliquota_cofins, trcst_interno,
trcfop_interno, trsct_pis, trcst_cofins, trcsosn_interno, traliquotauf, traliquotacst,
traliquotacfop, traliquotaaliquota,traliquotareducao_base, traliquotacson: string;
}
...
begin
 ...
 // DbCodNCM.Text := formatfloat('00000000', StrtoFloat(DbCodNCM.Text))    ;
  ...
  begin
    ...
    begin
      MessageDlg('O código NCM informação não possui no cadastro na Receita. Verifique!',mtWarning,[mbOK],0);
//      DbCodNCM.SetFocus;
    end
    else
    begin
  ...
  begin
    ...
    begin
      MessageDlg('O código NCM informação não possui no banco de dados. Verifique!',mtWarning,[mbOK],0);
//      DbCodNCM.SetFocus;
    end;
  end;
end;
